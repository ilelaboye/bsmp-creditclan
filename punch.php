...
<html lang="en">
 ...
 <body onload="sh_highlightDocument();">
  ...
  <? if ($ok): ?>
   <p><a target="_blank" href="<?= htmlentities($url) ?>">Proceed to <?= htmlentities($url) ?></a></p>
   <!-- <iframe src="<?= htmlentities($url) ?>" style="border: none; position:absolute; top:0; " height="100%" width="100%"></iframe> -->
  <? endif ?>
